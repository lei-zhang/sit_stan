  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      for (o in 1:4) {
        ...
        prob_sC2[o]  <- beta_cdf(0.5, evidW[s]*(cfoC2[s,t,o]+1) +machine_precision(), evidW[s]*(cfsC2[s,t,o]+1) +machine_precision());     
      }
      prob_oC2  <- 1 - prob_sC2;
...
generated quantities {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      for (o in 1:4) {
        prob_sC2_gen[o]  <- beta_cdf(0.5, evidW[s]*(cfoC2[s,t,o]+1) +machine_precision(), evidW[s]*(cfsC2[s,t,o]+1) +machine_precision() );
      }
