...
model {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      valfun2 <- bias[s] + beta[3,s] * valdiff + beta[4,s] * wgtWith[s,t] + beta[5,s] * wgtAgst[s,t];
...
generated quantities {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      valfun2_gen  <- bias[s] + beta[3,s] * valdiff_gen + beta[4,s] * wgtWith[s,t] + beta[5,s] * wgtAgst[s,t];
