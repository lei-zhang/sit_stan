...
model {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      otherValue[t+1,choice2[s,t]]   <- sum( wProb_sC2[s,t] ) / ( sum( wProb_sC2[s,t]) + sum( wProb_oC2[s,t]) );
      otherValue[t+1,3-choice2[s,t]] <- sum( wProb_oC2[s,t] ) / ( sum( wProb_sC2[s,t]) + sum( wProb_oC2[s,t]) );
...
generated quantities {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      otherValue2[t+1,choice2[s,t]]   <- sum( wProb_sC2[s,t] ) / ( sum( wProb_sC2[s,t]) + sum( wProb_oC2[s,t]) );
      otherValue2[t+1,3-choice2[s,t]] <- sum( wProb_oC2[s,t] ) / ( sum( wProb_sC2[s,t]) + sum( wProb_oC2[s,t]) );
    }  // trial loop
  }    // subject loop
}