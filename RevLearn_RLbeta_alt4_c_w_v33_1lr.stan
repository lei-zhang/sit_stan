...
model {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      valfun2[choice1[s,t]]   <- valfun1[choice1[s,t]] + beta[3,s] * wgtWith[s,t];
      valfun2[3-choice1[s,t]] <- valfun1[3-choice1[s,t]] + beta[4,s] * wgtAgst[s,t];
...
generated quantities {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      valfun2_gen[choice1[s,t]]   <- valfun1_gen[choice1[s,t]] + beta[3,s] * wgtWith[s,t];
      valfun2_gen[3-choice1[s,t]] <- valfun1_gen[3-choice1[s,t]] + beta[4,s] * wgtAgst[s,t];
