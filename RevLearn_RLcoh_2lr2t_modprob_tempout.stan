...
model {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      tmpv[3-choice1[s,t]] <- v1[t][3-choice1[s,t]] + coha[s] * against[s,t];
      tmpv[choice1[s,t]]   <- v1[t][choice1[s,t]]   + cohw[s] * with[s,t];
    
      //* compute action probs using built-in softmax function and related to choice data */
      choice2[s,t] ~ categorical_logit(tau2[s] * tmpv);
...
generated quantities {
  ...
  for (s in 1:nSubjects) {
    ...
    for (t in 1:nTrials) {
      ...
      tmpv1[3-choice1[s,t]] <- ev1[t][3-choice1[s,t]] + coha[s] * against[s,t];
      tmpv1[choice1[s,t]]   <- ev1[t][choice1[s,t]]   + cohw[s] * with[s,t];
      
      log_lik2[s] <- log_lik2[s] + categorical_logit_log(choice2[s,t], tau2[s] * tmpv1);
